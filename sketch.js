...
function setup() {
	...
	bob1=new Bob(240,400,30,30)
	bob2=new Bob(270,400,30)
	bob3=new Bob(300,400,30,30)
	bob4=new Bob(330,400,30,30)
	bob5=new Bob(360,400,30,30)
...
function keyPressed() {
	...
	if (keyCode === DOWN_ARROW) { 
		Matter.Body.applyForce(bob5.body,bob5.body.position,{x:225,y:-100})
